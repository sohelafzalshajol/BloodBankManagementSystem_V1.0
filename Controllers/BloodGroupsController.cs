...
namespace BloodBankMVC.Controllers
{
    ...
    public class BloodGroupsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,Status")] BloodGroup bloodGroup)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,Status")] BloodGroup bloodGroup)
        {
            if (ModelState.IsValid)
            {
